...
const Sidebar = () => {
  return (
    <>
      <aside
        className="fixed top-0 left-0 z-40 pt-14 w-64 h-screen bg-white border-r border-gray-200 transition-transform -translate-x-full md:translate-x-0 dark:bg-gray-800 dark:border-gray-700"
        aria-label="Sidenav"
        id="drawer-navigation"
      >
        <div className="overflow-y-auto px-3 py-5 h-full bg-white dark:bg-gray-800">
          <form action="#" method="GET" className="mb-2 md:hidden">
            ...
            <div className="relative">
              ...
              <input
                ...
                name="search"
                id="sidebar-search"
                className="block p-2 pl-10 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                placeholder="Search"
              />
            </div>
          </form>
        ...
        <div className="hidden absolute bottom-0 left-0 z-20 justify-center p-4 space-x-4 w-full bg-white lg:flex dark:bg-gray-800">
          <a
            href="#"
          ...
          <div
            id="tooltip-settings"
            role="tooltip"
            className="inline-block absolute invisible z-10 px-3 py-2 text-sm font-medium text-white bg-gray-900 rounded-lg shadow-sm opacity-0 transition-opacity duration-300 tooltip"
          >
            Settings page
